...
export default function AboutHero() {
  ...
  /* Particle canvas — same engine as SchoolHero */
  useEffect(() => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            >
              ...
              <span className="text-white/90 text-xs font-semibold tracking-wide">Est. 1998 · New Delhi · CBSE Affiliated</span>
            </div>
            ...
            <p className="reveal-hidden text-base sm:text-lg text-white/65 leading-relaxed mb-8 max-w-lg" style={{ transitionDelay: '0.2s' }}>
              For over 26 years, Greenwood Academy has been a beacon of quality education in New Delhi — shaping young minds, building character, and nurturing a lifelong love of learning.
            </p>
          ...
          <div className="relative hidden lg:flex items-center justify-center h-80">
            ...
            >
              <Icon name="BuildingLibraryIcon" size={32} className="text-white mb-1" />
              <div className="text-white font-bold text-lg leading-tight">26+</div>
              <div className="text-white/70 text-xs">Years of<br />Excellence</div>
            </div>

            {/* Orbiting cards */}
            {[
              { icon: 'AcademicCapIcon', label: '2,400+', sub: 'Students', color: 'from-blue-500 to-cyan-400', pos: 'top-0 right-12' },
              { icon: 'UserGroupIcon', label: '120+', sub: 'Faculty', color: 'from-violet-500 to-purple-400', pos: 'bottom-0 right-12' },
              { icon: 'TrophyIcon', label: '100%', sub: 'Pass Rate', color: 'from-amber-500 to-orange-400', pos: 'top-8 left-4' },
              { icon: 'ShieldCheckIcon', label: 'ISO', sub: '9001:2015', color: 'from-emerald-500 to-teal-400', pos: 'bottom-8 left-4' },
            ].map((card) => (
              <div
                key={card.label}
              ...
              >
                <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${card.color} flex items-center justify-center flex-shrink-0`}>
                  <Icon name={card.icon as 'TrophyIcon'} size={16} className="text-white" />
                </div>
                <div>
