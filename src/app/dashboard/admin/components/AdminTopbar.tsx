    ...
    <header className="h-16 bg-white border-b border-border/60 flex items-center gap-4 px-4 sm:px-6 flex-shrink-0 relative z-10">
      ...
      <div className="flex-1 max-w-md">
        <div className="relative">
          ...
          <input type="text" placeholder="Search students, teachers, fees..." className="w-full pl-9 pr-4 py-2 bg-background border border-border/60 rounded-xl text-sm text-foreground placeholder:text-muted-light focus:outline-none focus:border-primary/40 focus:ring-2 focus:ring-primary/10 transition-all" />
        </div>
      </div>
      <div className="flex items-center gap-2 ml-auto">
        ...
        <div className="flex items-center gap-2.5 pl-1 cursor-pointer group">
          <div className="w-9 h-9 rounded-xl bg-amber-100 flex items-center justify-center font-700 font-display text-amber-700 text-sm">
